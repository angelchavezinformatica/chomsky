from .utils.generate_combinations import generate_combinations

from .grammar import Grammar
from .types import GrammarType, SetStr, Tuple, UnitProductions


class Chomsky:
    EPSILON = Grammar.EPSILON

    def _process_productions(self, grammar: Grammar):
    ...
    def remove_epsilon_productions(
        ...
        @self._process_productions(grammar=grammar)
        ...
        if aux_grammar != grammar.grammar:
            ...
            @self._process_productions(grammar=new_grammar)
